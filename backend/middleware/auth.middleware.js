...
export const verifyToken = (req, res, next) => {
  ...
  // Bypass de desarrollo para recuperar acceso (Gestor/Admin)
  if (token === 'mock-jwt-aprobador') {
    req.user = { id: 'demo-aprobador-id', email: 'admin_director@yucatan.gob.mx', rol: 'aprobador' };
    return next();
  }
